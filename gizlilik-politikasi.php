...
<head>
    ...
    <title>Gizlilik Politikası | marketisleri.com</title>
    <meta name="description" content="marketisleri.com Gizlilik Politikası sayfası. Verilerinizin nasıl işlendiği ve korunduğu hakkında detaylı bilgilendirme.">
    ...
    <main class="pt-8 max-w-4xl w-full mx-auto px-4 md:px-6 flex-1 pb-16">
        ...
        <div class="bg-white border border-slate-100 rounded-3xl p-8 md:p-12 shadow-md space-y-8">
            ...
            <div class="space-y-6 text-slate-600 leading-relaxed">
                <p>
                    <strong>marketisleri.com</strong> olarak kişisel verilerinizin güvenliği ve gizliliği bizim için son derece önemlidir. Bu Gizlilik Politikası, web sitemizi ziyaret ettiğinizde veya bültenimize abone olduğunuzda hangi verileri topladığımızı, bu verileri nasıl kullandığımızı ve nasıl koruduğumuzu açıklamaktadır.
                </p>

                <h3 class="font-title text-xl font-bold text-slate-900 pt-4">1. Toplanan Kişisel Veriler</h3>
                <p>
                    Sitemizi ziyaret ettiğinizde herhangi bir kişisel veri paylaşmanıza gerek yoktur. Ancak aşağıdaki durumlarda belirli bilgileri toplayabiliriz:
                </p>
                <ul class="list-disc pl-6 space-y-2">
                    <li><strong>E-Bülten Aboneliği:</strong> Yeni broşürler ve kampanyalar eklendiğinde bildirim almak amacıyla kendi rızanızla bıraktığınız e-posta adresi.</li>
                    <li><strong>Çerezler ve Analitik Veriler:</strong> Sitemizin performansını artırmak ve kullanıcı deneyimini optimize etmek amacıyla IP adresi, tarayıcı türü, ziyaret süresi ve tıklanan sayfalar gibi anonim kullanım istatistikleri.</li>
                </ul>

                <h3 class="font-title text-xl font-bold text-slate-900 pt-4">2. Verilerin Kullanım Amaçları</h3>
                <p>
                    Toplanan veriler yalnızca aşağıdaki amaçlar doğrultusunda kullanılır:
                </p>
                <ul class="list-disc pl-6 space-y-2">
                    <li>Kullanıcılara talep ettikleri yeni broşür ve kampanya bildirimlerini göndermek (E-Bülten aboneleri için).</li>
                    <li>Sitemizin kullanıcı dostu olmasını sağlamak ve performansı analiz etmek.</li>
                    <li>Yasal yükümlülüklere uyum sağlamak.</li>
                </ul>

                <h3 class="font-title text-xl font-bold text-slate-900 pt-4">3. Verilerin Üçüncü Şahıslarla Paylaşımı</h3>
                <p>
                    Kişisel e-posta adresleriniz asla üçüncü taraflara satılmaz, kiralanmaz veya ticari amaçlarla paylaşılmaz. Verileriniz, yalnızca yasal olarak zorunlu olduğu durumlarda adli makamlarla paylaşılabilecektir. Reklam ortaklarımız (örneğin Google AdSense), kişiselleştirilmiş reklam göstermek amacıyla kendi çerez politikalarına tabi olarak anonim çerez bilgileri toplayabilir.
                </p>

                <h3 class="font-title text-xl font-bold text-slate-900 pt-4">4. Veri Güvenliği</h3>
                <p>
                    E-posta adreslerinizin ve kullanım verilerinizin yetkisiz erişim, kayıp veya suiistimale karşı korunması için teknik ve idari güvenlik önlemleri uygulanmaktadır. Sunucularımız ve veri depolama sistemlerimiz güncel güvenlik protokolleri ile korunmaktadır.
                </p>

                <h3 class="font-title text-xl font-bold text-slate-900 pt-4">5. Kullanıcı Hakları ve İletişim</h3>
                <p>
                    Dilediğiniz zaman bülten aboneliğinden çıkma hakkına sahipsiniz. Bülten aboneliğinizi sonlandırmak veya kişisel verilerinizin silinmesini talep etmek için bizimle iletişime geçebilirsiniz. Aboneliğinizi size gönderilen bilgilendirme e-postalarının altındaki bağlantı aracılığıyla da anında iptal edebilirsiniz.
                </p>
            </div>
        </div>
    ...
    <footer class="bg-white border-t border-slate-100 py-10 mt-auto">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-slate-500 font-medium my-4 md:my-0">
                <a href="gizlilik-politikasi.php" class="text-red-600 font-bold transition">Gizlilik Politikası</a>
